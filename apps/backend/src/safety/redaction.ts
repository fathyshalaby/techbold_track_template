...
const REDACTION_PATTERNS: RedactionPattern[] = [
  ...
  // JSON-encoded variants: "key":"value" or "key": "value"
  {
    ...
    pattern:
      /("[A-Za-z0-9_-]*(?:token|secret|passwd|password|api[_-]?key|key|authorization|auth|credential)[A-Za-z0-9_-]*"\s*:\s*)"[^"]*"/gi,
    replacement: '$1"«redacted»"',
  },
  {
    name: "env-secret-var",
    ...
    pattern:
      /\b([A-Za-z_]*(?:SECRET|TOKEN|KEY|PASS|PASSWORD|CREDENTIAL|secret|token|key|pass|password|credential)[A-Za-z_0-9]*\s*=\s*)(?!«redacted»)\S+/g,
    replacement: "$1«redacted»",
  },
  {
    name: "secret-header",
  ...
  },
  {
    ...
    pattern:
      /\b(?:gh[pousr]_[A-Za-z0-9]{20,}|xox[baprs]-[A-Za-z0-9-]{10,}|sk-[A-Za-z0-9]{20,}|sk_live_[A-Za-z0-9]{16,}|rk_live_[A-Za-z0-9]{16,}|glpat-[A-Za-z0-9_-]{16,}|AIza[A-Za-z0-9_-]{16,}|ya29\.[A-Za-z0-9_-]{20,})/g,
    replacement: "«redacted»",
  },
  {
