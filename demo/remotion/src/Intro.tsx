  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", opacity, transform: `translateY(${y}px)` }}>
        <div style={{ letterSpacing: 10, color: "#2dd4bf", fontSize: 24, fontWeight: 600 }}>TEAM&nbsp;&nbsp;SPHINX</div>
        <div style={{ fontSize: 92, fontWeight: 700, color: "#e8eef6", marginTop: 10, letterSpacing: -1 }}>
          AI Service Desk Autopilot
        </div>
        <div style={{ height: 3, width: line, background: "#2dd4bf", margin: "26px auto", borderRadius: 2 }} />
        <div style={{ color: "#93a1b4", fontSize: 28 }}>reads tickets · fixes Linux over SSH · documents it back</div>
      </div>
    </AbsoluteFill>
  );
};
