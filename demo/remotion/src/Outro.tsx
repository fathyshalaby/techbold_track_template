  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", opacity }}>
        <div style={{ fontSize: 76, fontWeight: 700, color: "#e8eef6", letterSpacing: -1 }}>Sphinx</div>
        <div style={{ color: "#2dd4bf", letterSpacing: 6, fontSize: 18, marginTop: 6 }}>AI SERVICE DESK AUTOPILOT</div>
        <div style={{ marginTop: 30, display: "flex", flexDirection: "column", gap: 10 }}>
          {FACTS.map((f, i) => {
            const op = interpolate(frame, [10 + i * 8, 22 + i * 8], [0, 1], { extrapolateRight: "clamp" });
            return (
