// Sphinx — clean walkthrough recorder for the Autopilot console (ticket #7001).
//
...
//
// Output: demo/recording/<id>.webm  →  feed into the Remotion project (demo/remotion) to polish.
//
