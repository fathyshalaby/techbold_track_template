# Pitch deck — Service Desk Autopilot
...
- 👁️ **View:** https://www.canva.com/d/Usjrba32cYQHRvW
- ✏️ **Edit:** https://www.canva.com/d/-2va1E71SUMYWqq
...
4–6. The solution: the human-in-the-loop loop, and *the crux* — the model can't touch the VM
7–10. The four differentiators: diagnosis-first · safety-by-design · audit-as-source-of-truth · generalisation
11. Architecture
12. The human-control surface
13. How we win the rubric (55/100 = B + C)
14. What's real today (honest status)
15. What we'll show live
16. Why it wins / close
