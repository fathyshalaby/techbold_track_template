...
export const MOCK_CUSTOMER_SYSTEMS: Record<number, CustomerSystem> = {
  1: { ticket_id: 1, customer_id: 1001, system: { ip: '10.0.0.1', port: 22, username: 'azureuser', os: 'Ubuntu 22.04 LTS' } },
  2: { ticket_id: 2, customer_id: 1002, system: { ip: '10.0.0.2', port: 22, username: 'azureuser', os: 'Ubuntu 22.04 LTS' } },
  3: { ticket_id: 3, customer_id: 1003, system: { ip: '10.0.0.3', port: 22, username: 'azureuser', os: 'Ubuntu 22.04 LTS' } },
...
export default class MockPhoenixClient {
  ...
  async getMe(): Promise<Employee> {
    return Promise.resolve({ id: 1, firstname: 'Demo', lastname: 'Tech', username: 'demo.tech', teamname: 'Support' });
  }
