  ...
  cues: [
    {
      ...
      to: 8,
      label: "Load ticket",
      sub: "Pulled from the Phoenix ERP · SSH target loaded",
    },
    { from: 8, to: 23, label: "Diagnose", sub: "Read-only diagnostics stream into a live trace" },
    {
      from: 23,
      to: 37,
      label: "Human approves the fix",
      sub: "Every write is gated: approve · edit · reject",
    },
    { from: 37, to: 45, label: "Validate", sub: "Service healthy · persists across reboot" },
    {
      ...
      to: 54,
      label: "Document → ERP",
      sub: "Root cause + commands + proof, written back",
    },
  ],
};
